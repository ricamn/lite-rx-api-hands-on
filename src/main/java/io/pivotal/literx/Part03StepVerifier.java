...
public class Part03StepVerifier {
	...
	// TODO Use StepVerifier to check that the flux parameter emits "foo" and
	// "bar" elements then completes successfully.
	...
	// TODO Use StepVerifier to check that the flux parameter emits "foo" and
	// "bar" elements then a RuntimeException error.
	...
	// TODO Expect 3600 elements then complete using the virtual time
